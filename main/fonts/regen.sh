...
#                 STOP, NEXT, DIRECTORY, BATTERY_FULL..EMPTY,
#                 LEFT (0xF053), RIGHT (0xF054)  (lásd lv_symbol_def.h)
#   Saját ikonok (mp3_fonts.h): LOCK (0xF023), UNLOCK (0xF09C)
#
...
SYMBOLS="0xF001,0xF021,0xF023,0xF026-0xF028,0xF048,0xF04B-0xF04D,0xF051,0xF053-0xF054,0xF07B,0xF09C,0xF240-0xF244"
LATIN_BASIC="0x20-0x7E,0xA0-0xFF"
LATIN_EXT="0x0150-0x0151,0x0170-0x0171"

for SIZE in 12 14 18 24; do
